// This modules operates ONLY on the Stripe API
...
module.exports = function(stripe_secret_key){
        ...
        var delete_customer = function(stripe_customer_id, callback){
        ...
        var fetch_customer = function(stripe_customer_id, callback){
        ...
        var fetch_default_source = function(stripe_customer_id, callback){
          stripe.customers.retrieve(
            stripe_customer_id,
            function(err, customer) {
              completion_action.call(this,
        ...
        var create_credit_card_token = function(card_num, exp_month, exp_year, cvc, zip, callback){
        ...
        var  new_default_card = function(stripe_customer_id, new_card_token, callback){
        ...
        var delete_card = function(stripe_customer_id, card_token, callback){
        ...
        var completion_action = function(err,  obj, callback) {
          ...
          (function() {
            util.throw_or_log.call(this, err, obj, callback);
          })();
        }
        ...
        return {
          ...
          fetch_default_source:fetch_default_source,
